...
export async function executeVoiceTool(input: { call: VoiceToolCallRecord; ctx: ExtensionContext | undefined; state: RealtimeState; controlPlane: ControlPlane }): Promise<string> {
	...
	if (call.name === "pi_send_instruction") return sendInstructionFromTool(call, ctx, controlPlane);
...
async function sendInstructionFromTool(call: VoiceToolCallRecord, ctx: ExtensionContext, controlPlane: ControlPlane): Promise<string> {
