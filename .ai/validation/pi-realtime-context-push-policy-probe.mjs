...
assert.match(updates, /Speak only the text inside <speak_this_verbatim>/);
assert.match(updates, /Do not summarize\. Ever\./);
assert.match(updates, /Literal delivery of <speak_this_verbatim> content is correct; helpful summarization is failure/);
