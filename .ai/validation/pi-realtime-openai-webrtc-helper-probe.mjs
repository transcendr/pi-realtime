...
assert.match(ephemeral, /interrupt_response: false/);
...
assert.match(client, /MIC_RESUME_DELAY_MS/);
assert.match(client, /holdMicrophone/);
assert.match(client, /setMicrophoneEnabled\(false/);
assert.match(client, /response\.created/);
